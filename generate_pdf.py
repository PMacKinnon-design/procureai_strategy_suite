...
class MacKinnonPDF(FPDF):
    def header(self):
        ...
        self.set_xy(0, 15)
        self.cell(210, 10, "AI Strategy for Procurement | Powered by MacKinnon Consulting", ln=True, align="C")
        self.set_font("Helvetica", "", 12)
        self.cell(210, 10, "Prepared by MacKinnon Consulting", ln=True, align="C")
        self.ln(3)
    ...
    def footer(self):
        ...
        self.cell(210, 10, "MacKinnon Consulting | Setting the Standard in Procurement Strategy", 0, 0, "C")
