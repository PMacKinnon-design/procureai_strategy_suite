...
class MacKinnonPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 8, "AI Strategy for Procurement", ln=True, align="C")
        self.set_font("Helvetica", "", 12)
        self.cell(0, 8, "Prepared by MacKinnon Consulting", ln=True, align="C")
        self.ln(5)
    ...
    def footer(self):
        ...
        self.cell(0, 10, "MacKinnon Consulting | Confidential", 0, 0, "C")
