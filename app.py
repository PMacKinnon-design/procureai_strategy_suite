...
if mode == "🔍 Procurement Health Check":
    ...
    with col1:
        ...
        with open("KPI_Instructions.pdf", "rb") as f:
            st.download_button("📘 Download KPI Instructions (PDF)", f, file_name="KPI_Instructions.pdf")
...
if hc_file:
    try:
        ...
        st.subheader("📊 Health Check Scores Summary")
