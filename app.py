...
if tool_choice == "🩺 Procurement Health Check":
    ...
    if hc_file and kpi_file:
        st.success("✅ Files uploaded. [Placeholder] Process and display Health Check analysis...")
        st.markdown("📊 [Placeholder] Show KPI Score Table & Bar Charts (1–5 scale)")
        st.markdown("📄 [Placeholder] Generate AI-augmented Operational Health Report")
