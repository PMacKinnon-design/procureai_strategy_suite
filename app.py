...
Download the templates below and share them with your Procurement team. Each team member can complete their own version.
Afterward, calculate the **average score for each question** and upload the consolidated file.

- [📄 Health Check Template](./Health_Check_Questionnaire_Template.xlsx)
- [📄 AI Readiness Template](./AI_Readiness_Questionnaire_Template.xlsx)
""")

with open("Health_Check_Questionnaire_Template.xlsx", "rb") as f:
...
st.markdown("### 📤 Step 2: Upload Completed Health Check and AI Readiness Files")
