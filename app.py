...
st.markdown("<h1 style='color: #1F4E79;'>ProcureAI Strategy Suite – Strategy Report Enabled</h1>", unsafe_allow_html=True)
st.markdown("### ℹ️ You are running the **full version** with grouped charts and AI strategy reporting.")
