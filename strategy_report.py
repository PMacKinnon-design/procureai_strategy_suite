...
"""
    ...
    polish_prompt = f"""
You are a professional strategy editor. Refine the following strategy report written by a consultant. Your task is to:

1. Eliminate repetitive or redundant ideas between sections
2. Improve transitions and flow across the sections
3. Ensure third-person voice and strategic tone throughout
4. Preserve all insights and structure, but enhance clarity and style

Do not shorten it. Do not use markdown or formatting characters.

Here is the full strategy report:
{full_report}
